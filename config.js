...
const SUDO = process.env.SUDO || '9233255427063';
const AUTO_STATUS_VIEW = process.env.AUTO_STATUS_VIEW || "true";
const ALWAYS_ONLINE = process.env.ALWAYS_ONLINE || "false";
const BOT_INFO = process.env.BOT_INFO || "GOJO-BOT-MD;MR UZAIR;https://imgur.com/a/3nyIGF6.jpeg";
const URL = process.env.URL || "https://www.instagram.com/imspxxky";
const AUDIO_DATA = process.env.AUDIO_DATA || "GOJO-BOT-MD;MR UZAIR;https://imgur.com/a/3nyIGF6.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "GOJO-BOT-MD;MR UZAIR";
